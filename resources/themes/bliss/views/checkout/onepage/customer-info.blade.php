...
<div class="form-container row">
    ...
    <div class="col-lg-4">
        <div class="form-group" :class="[errors.has('address-form.billing[postcode]') ? 'has-error' : '']">
            ...
            <input @change="validateAddressForm" type="text" v-validate="'required'" placeholder="{{ __('shop::app.checkout.onepage.postcode') }}" class="control form-control user_info" id="billing_postcode" name="billing[postcode]" v-model="address.billing.postcode" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.postcode') }}&quot;"/>
